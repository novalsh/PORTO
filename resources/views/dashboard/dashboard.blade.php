...
@section('main-content')
    ...
    <body class="font-poppins scroll-smooth">
        <!-- navbar start -->
        <header class="bg-transparent absolute top-0 lef-0 w-full flex items-center z-1">
            <div class="container">
                    ...
                    <div class="flex items-center px-1">
                        ...
                        <nav id="nav-menu"
                            ...
                            <ul class="block lg:flex">
                                ...
                                <li class="group">
                                    <a href="#skills"
                                        class="text-base text-dark py-2 mx-8 flex hover:text-primary">Skills</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                ...
                <div class="flex flex-wrap">
                    <div class="w-full self-center px-4 lg:w-1/2">
                        <h1 class="text-base text-primary md:text-xl">Halo Semua ✋ Saya, <span
                                class="block font-bold text-dark text-2xl mt-1 lg:text-4xl max-w-md">Muhammad Naufal</span>
                        </h1>
                        <h2 class="font-medium mb-10 lg:text-2xl">Mahasiswa</h2>

                        <a href="https://www.instagram.com/nvllsh_"
                    ...
                    <div class="w-full self-end px-4 lg:w-1/2">
                        <div class="relative mt-10 lg:mt-0 lg:right-0">
                            <img class="title-image"src="img/profile.png" alt="Muhammad Naufal" class="max-w-full mx-auto">
                            <span class="absolute -bottom-6 -z-10 left-1/2 -translate-x-1/2 md:scale-125">
                                <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" width="400" height="400"
                                    class="invisible md:visible">
                                    <path fill="#c026d3"
                                        d="M50.7,-40.9C59.7,-29.2,56.8,-8.5,51.3,10.1C45.8,28.7,37.7,45.2,22.4,56.5C7,67.7,-15.8,73.8,-32.6,66.3C-49.4,58.7,-60.3,37.5,-66.1,14.4C-71.8,-8.6,-72.5,-33.5,-60.6,-45.9C-48.8,-58.3,-24.4,-58.2,-1.8,-56.8C20.9,-55.4,41.8,-52.7,50.7,-40.9Z"
            ...
            <div class="container">
                <div class="flex flex-wrap">
                    <div class="w-full px-4 mb-10 lg:w-1/2">
                        ...
                        <p class="font-medium text-base text-secondary max-w-xl lg:text-lg">Halo, nama saya Muhammad Naufal
                            Sinai Harjana biasa dipanggil Noval. Saya adalah mahasiswa jurusan Computer Science di
                            Universitas Bina Nusantara</p>
                    </div>
                    <div class="w-full px-4 lg:w-1/2">
                        ...
                        <p class="font-medium text-base text-secondary mb-6 lg:text-lg">Untuk mengetahui keseharianku atau
                            karya-karya lain yang aku bikin kalian dapat melihat di social mediaku yang bisa kalian kunjungi
                            dengan menekan tombol dibawah</p>
                        <div class="flex items-center">
                            <!-- instagram -->
                            <a href="https://instagram.com/nvllsh_" target="_blank"
        ...
        <section id="portfolio" class="pt-36 pb-32 bg-zinc-200">
            <div class="container">
                <div class="w-full px-4">
                    <div class="max-w-xl mx-auto text-center">
                        <img src="img/coding.gif" alt="coding" class="w-70 h-70 mx-auto mb-5">
                        <h2 class="font-bold text-dark text-3xl mb-4 sm:text-4xl lg:text-5xl">My Project</h2>
                        <p class="text-md font-medium text-secondary md:text-lg">Berikut ini adalah karya-karya website dan
                            experience yang pernah saya lakukan</p>
                    </div>
                    <div class="w-full px-4 flex flex-wrap justify-center xl:w-10/12 mx-auto">
                        <div class="mb-12 p-4 md:w-1/2">
                            <div class="rounded-md shadow-md overflow-hidden">
                                <a href="https://tickat.fikriyuwi.com" target="_blank">
                                    <img src="img/tickat.png" alt="Tickat" width="w-full">
                                    <h3 class="font-semibold text-xl text-dark mt-5 mb-3">Tickat Website</h3>
                                    <p class="font-medium text-base text-secondary">Website ini adalah website yang dibuat
                                        untuk melakukan transaksi pembelian ticket jika terdapat suatu event. Website ticket
                                        tersebut dibuat dengan framework laravel dan mysql sebagai database</p>
                                </a>
                            </div>
                        </div>
                        <div class="mb-12 p-4 md:w-1/2">
                            <div class="rounded-md shadow-md overflow-hidden">
                                <a href="https://github.com/novalsh?tab=repositories/" target="_blank">
                                    <img src="img/vueStore.png" alt="E-commerce web" width="w-full">
                                    <h3 class="font-semibold text-xl text-dark mt-5 mb-3">E-commerce Website</h3>
                                    <p class="font-medium text-base text-secondary">Website ini adalah website e-commerce
                                        yang dibuat untuk menjual beli barang. Website Store tersebut dibuat dengan Vue.js
                                        sebagai front-end nya, Node express sebagai back-end nya, dan MongoDB sebagai
                                        databasenya </p>
                                </a>
                            </div>
                        </div>
                        <div class="mb-12 p-4 md:w-1/2">
                            <div class="rounded-md shadow-md overflow-hidden">
                                ...
                                <h3 class="font-semibold text-xl text-dark mt-5 mb-3">Freshman Leader FYP B26</h3>
                                <p class="font-medium text-base text-secondary">Freshmam Leader merupakan sebuah event yang
                                    dimana mahasiswa/mahasiswi yang telah dilatih oleh kampus untuk dapat menjadi pemimpin
                                    ke mahasiswa baru dalam menyesuaikan diri dengan lingkungan kampus dan kehidupan
                                    perguruan tinggi</p>
                                </a>
                            </div>
                        </div>
        ...
        <!-- skill section start -->
        <section id="skills" class="pt-36 pb-32 bg-zinc-500">
            <div class="container">
                <div class="w-full px-4">
                    <div class="max-w-xl mx-auto text-center">
                        <img src="img/giphy.gif" alt="skill" class="w-70 h-70 mx-auto mb-5">
                        <h2 class="font-bold text-white text-3xl mb-4 sm:text-4xl lg:text-5xl">My Skills</h2>
                        <p class="text-md font-medium text-slate-900 md:text-lg">Berikut adalah bahasa pemrograman dan
                            teknologi-teknologi yang aku kuasai</p>
                    </div>
                ...
                <div class="w-full px-4">
                    <div class="flex flex-wrap items-center justify-center">
                        <img src="./img/html5.png"
                            class="max-w-[120px] grayscale px-4 py-4 opacity-80 duration-500 hover:grayscale-0 hover:opacity-100 lg:mx-6 xl:mx-8"
                            alt="html5">
            ...
            <div class="container">
                <div class="w-full px-4">
                    <div class="max-w-xl mx-auto text-center">
                        ...
                        <p class="text-md font-medium text-secondary md:text-lg mb-4">Kalian dapat menghubungi saya dengan
                            mengisi form dibawah:</p>
                    </div>
                </div>
                <form action="mailto:aliefm144@gmail.com" method="post">
                    <div class="w-full lg:w-2/3 lg:mx-auto" id="contact">
                        ...
                        <div class="w-full px-4">
                            <button href="https://www.instagram.com/nvllsh_/"
            ...
            <div class="container">
                <div class="flex flex-wrap justify-center">
                    <div class="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/2 md:mx-auto">
                        <h2 class="font-bold text-4xl text-white mb-5">Noval</h2>
                        <h3 class="font-bold text-2xl mb-2">Contact Us</h3>
                        <p>sinai.noval23@gmail.com</p>
                        <p>Taman Pondok Jati Blok CS - 3</p>
                        <p>Sidoarjo</p>
                    </div>
                    <div class="w-full px-4 mb-12 md:w-1/2 md:mx-auto">
                        ...
                        <ul class="text-slate-300">
                            ...
                            <li><a href="#skills" class="hover:text-primary duration-500 transition">Skills</a></li>
                ...
                <div class="w-full pt-10 border-t border-slate-400">
                    ...
                    <p class="font-medium text-sm text-slate-200 text-center">Made by <span class="text-pink-500">❤</span>
                        <a target="_blank" href="https://github.com/novalsh" class="font-bold text-primary">Muhammad
                            Naufal</a>, Using <a target="_blank" href="https://www.tailwindcss.com"
                            class="font-bold text-violet-400">Tailwind CSS 3</a>
                    </p>
                </div>
            </div>
        </footer>
